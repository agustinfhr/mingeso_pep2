...
import com.tingeso.oficinaRRHHservice.models.ProveedorModel;
import com.tingeso.oficinaRRHHservice.models.SubirDataModel;
import com.tingeso.oficinaRRHHservice.models.SubirValorModel;

import com.tingeso.oficinaRRHHservice.repositories.PlanillaRepository;
...
public class PlanillaService {
    ...
    public void calcularPlanillas(){
        ...
        ArrayList<ProveedorModel> proveedores = restTemplate.getForObject("http://empleado-service/proveedor/", ArrayList.class);
        // VARIABLES FINALES
        String quincena = " ";
        ...
        for (ProveedorModel proveedor : proveedores) {
            ...
            ArrayList<SubirDataModel> datas = restTemplate.getForObject("http://marcas-reloj-service/subir-data/" + codigoProveedor, ArrayList.class);

            //SubirValorEntity valor = valorRepository.findByProveedor(codigoProveedor);
            SubirValorModel valor = restTemplate.getForObject("http://justificativo-service/subir-valor/porproveedor/" + codigoProveedor, SubirValorModel.class);
    ...
    public int klsLeche(Integer totalKlsLeche, SubirDataModel data){
    ...
    public int pagoPorGrasa(Integer klsLecheProveedor, SubirValorModel valor, Integer interruptor){
    ...
    public int pagoPorST(Integer klsLecheProveedor, SubirValorModel valor, Integer interruptor){
